...
public:
	...
	void readPic(LPCSTR);
	void /*TO-DO：可能你需要修改返回类型 END*/ getData(Array& DATA, UINT& _x, UINT& _y);
...
void /*TO-DO：可能你需要修改返回类型 END*/ PicReader::getData(Array& DATA, UINT& _x, UINT& _y) {
	HRESULT hr = S_OK;
	...
	******************************************************************/
	...
	Array mydata(4*x*y);
	mydata.ischild = true;//防止mydata在这里被析构
